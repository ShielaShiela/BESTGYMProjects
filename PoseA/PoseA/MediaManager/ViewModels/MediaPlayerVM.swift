...
class FrameCache {
    ...
    private let preloadCount = 3  // Preload ahead 3 frames
...
class MediaPlayerVM {
    ...
    private var FrameFolderURLs: [URL] = []
    ...
    func updateMedia(imageURLs: [URL], folderURLs: [URL]) {
        // Update Media Variables
        self.FrameImageURLs = imageURLs
        self.FrameFolderURLs = folderURLs
