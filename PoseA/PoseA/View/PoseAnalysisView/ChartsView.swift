...
struct ChartsView: View {
    ...
    init(chartData: [JointData], timeRange: ClosedRange<Double>, currentFrameIndex: Int, yAxisUnit: String = "") {
    ...
    private func calculateYScale() {
        ...
        baseYScale = (minY - yPadding)...(maxY + yPadding)
    }
    ...
    private func calculateScales() {
        ...
        baseXScale = (minX - xPadding)...(maxX + xPadding)
        baseYScale = (minY - yPadding)...(maxY + yPadding)
    }
}
