...
//  DataCaptureTest
//
//  Created by Shiela Cabahug on 2024/7/5.
//
...
//    @Binding var minDepth: Float
//    
//    var capturedData: CameraDataViewModel
//    
//    func makeCoordinator() -> MTKColorZapCoordinator {
//        MTKColorZapCoordinator(parent: self)
//    }
...
//    
//    override func draw(in view: MTKView) {
//        // FIX: Access textures through cameraData property
//        guard parent.capturedData.cameraData.colorY != nil && parent.capturedData.cameraData.colorCbCr != nil else {
//            print("There's no content to display.")
//            return
//        }
//        
...
//        
//        // FIX: Access textures through cameraData property
//        encoder.setFragmentTexture(parent.capturedData.cameraData.depth!, index: 2)
//        encoder.setFragmentTexture(parent.capturedData.cameraData.colorY!, index: 0)
//        encoder.setFragmentTexture(parent.capturedData.cameraData.colorCbCr!, index: 1)
//        
//        encoder.setDepthStencilState(depthState)
//        encoder.setRenderPipelineState(pipelineState)
//        encoder.drawPrimitives(type: .triangleStrip, vertexStart: 0, vertexCount: 4)
