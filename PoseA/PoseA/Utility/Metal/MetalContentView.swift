...
//    func addGestures(to view: MTKView, context: Context)
}
...
//        addGestures(to: mtkView, context: context)
        return mtkView
    }
...
//    func addGestures(to view: MTKView, context: Context) {
//            let panGesture = UIPanGestureRecognizer(target: context.coordinator, action: #selector(MTKCoordinator<Self>.handlePanGesture(_:)))
...
//        
//        print("Pan gesture recognized. Offset: \(panOffset)")  // Debug print
//    }
}
